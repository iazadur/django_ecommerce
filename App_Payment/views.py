...
def payment(request):
    ...
    store_id = 'iazad60c7fab034afc'
    API_Key = 'iazad60c7fab034afc@ssl'
    ...
    mypayment.set_product_integration(total_amount=Decimal(order_total), currency='BDT', product_category='clothing',
...
def complete(request):
    if request.method == 'POST' or request.method == 'post':
        ...
        if status == 'VALID':
            ...
            messages.warning(request, f"Your Paymnet Failed! Please Try Again!  Page will be redirected!")
